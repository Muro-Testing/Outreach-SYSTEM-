...
export function App() {
    ...
    function onExportOutreach() {
        ...
        downloadCsv([headers, ...outreachRows.map(r => [r.name, r.email?.endsWith("@pending.local") ? "" : r.email, r.phone ?? "", r.website ?? "", r.location_text ?? "", r.opener_subject, r.opener_body, r.followup1_subject, r.followup1_body, r.followup2_subject, r.followup2_body])], `outreach-${slug}-${created}.csv`);
    }
