...
export function App() {
    ...
    const latestRunEvent = run?.errors?.find((item) => item.error_message.startsWith("[info]"))?.error_message.replace(/^\[info\]\s*/, "") ?? "";
